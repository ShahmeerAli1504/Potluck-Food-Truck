        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-script text-brand-gold text-base -mt-1">The Good Luck Truck</p>
              </div>
            </Link>

            <p className="text-xs text-brand-cream/70 max-w-sm leading-relaxed">
              Reno Nevada's premier Asian-fusion food truck with a Mexican twist. Serving Cheeseburger Wonton Tacos, Elote Chicken Fries, and pan-seared potstickers.
            </p>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-semibold">
              ...
              <li>
                <a href="#find-us" className="hover:text-brand-red transition-colors">
                  Find Today's Truck Location
                </a>
              </li>
              <li>
                <a href="#catering" className="hover:text-brand-red transition-colors">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="space-y-2 text-xs text-brand-cream/80">
              <p className="flex items-start gap-2">
                ...
                <span>Reno &bull; Sparks &bull; Truckee Meadows &bull; Northern Nevada</span>
              </p>
              ...
              <p className="flex items-center gap-2">
                ...
                <a href="mailto:catering@potlucktruckreno.com" className="hover:text-white font-bold">
